...
function HeroHome() {
  ...
  return (
    <section className="relative">
      ...
      <div
        className="-z-1 pointer-events-none absolute left-1/2 bottom-0 -translate-x-1/2 transform"
        aria-hidden="true"
      >
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="pb-12 text-center md:pb-16">
            ...
            <div className="mx-auto max-w-3xl">
              <p className="mb-8 text-xl text-gray-400" data-aos="zoom-y-out" data-aos-delay="150">
                I am a Software Developer, and currently half way done with my Software Engineer
                BSc.
              </p>
              <div
              ...
              >
                <div>
                  <a
                    className="mb-4 w-full rounded-3xl bg-blue-600 px-8 py-3 text-white hover:bg-blue-700 sm:mb-0 sm:w-auto"
                    href="#0"
                  >
                    Read
                  </a>
                ...
                <div>
                  <a
                    className="w-full rounded-3xl bg-gray-900 px-8 py-3 text-white hover:bg-gray-800 sm:ml-4 sm:w-auto"
                    href="#0"
                  >
                    Learn more
                  </a>
